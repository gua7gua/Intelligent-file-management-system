...
-- This script is psql-compatible and rebuilds the empty schema first.

\ir archive_empty.sql
...
INSERT INTO users (
  ...
  (1, 'internal', 'chen.front', 'A001', '13800000001', 'demo-bcrypt-hash', '小陈', 1, '接收服务部', 2, 'all', 'active'),
  (2, 'internal', 'liu.back', 'A002', '13800000002', 'demo-bcrypt-hash', '小刘', 1, '档案管理部', 3, 'all', 'active'),
  (3, 'internal', 'zhang.transfer', 'F001', '13800000003', 'demo-bcrypt-hash', '小张', 2, '财务处', 0, 'own_org', 'active'),
  (4, 'internal', 'li.reader', 'F002', '13800000004', 'demo-bcrypt-hash', '小李', 2, '预算处', 1, 'own_org', 'active'),
  (5, 'public', 'zhou.public', NULL, '13800000005', 'demo-bcrypt-hash', '小周', NULL, NULL, 0, 'own_org', 'active'),
  (6, 'internal', 'fang.director', 'L001', '13800000006', 'demo-bcrypt-hash', '小方', 1, '馆领导', 4, 'all', 'active'),
  (7, 'internal', 'admin', 'S001', '13800000007', 'demo-bcrypt-hash', '系统管理员', 1, '信息中心', 0, 'all', 'active'),
  (8, 'internal', 'wang.transfer', 'C001', '13800000008', 'demo-bcrypt-hash', '王敏', 3, '综合办公室', 0, 'own_org', 'active');
